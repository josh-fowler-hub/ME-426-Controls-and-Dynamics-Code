# -*- coding: utf-8 -*-
"""
Created on Wed Oct  3 13:05:31 2018
...
plt.legend()
plt.grid()
plt.savefig('Controls_Project_3_output.png', bbox_inches='tight')
plt.show()
...
plt.legend()
plt.grid()
plt.savefig('Controls_Project_3_velocity.png', bbox_inches='tight')
plt.show()
